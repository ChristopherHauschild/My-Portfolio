            ...
            <GridDescription container item sm={12} md={8}>
              <PaperDescription>
                ...
                <TypographyDescriptionBirthday>
                  ...
                  <ContainerDescription>
                    <IconItem>
                      ...
                      <Data><i>Focusing</i></Data>
                    </IconItem>

                    <IconItem>
                      <CakeIconDescription />
                      <Data><i>17/05/2001</i></Data>
                    </IconItem>

                    <IconItem>
                      <PublicIconDescription />
                      <Data><i>Rio Grande do Sul, Brasil</i></Data>
                    </IconItem>
                  </ContainerDescription>
                ...
                <TypographyDescriptionContent>
                  <b>Considerações:</b> apaixonado pelo conhecimento, busco sempre me aprimorar e expandir
                  minhas fronteiras, seja através de cursos, livros ou me arriscando em projeto pessoais, como este.
                  Há alguns anos tenho desenvolvido uma base forte nas tecnologias padrões do desenvolvimento web (<i>HTML, CSS e Javascript</i>),
                  e por conta disso decidir dar um passo além e desde então me tornei um entusiasta das novas tecnologias, correndo atrás para estar sempre por dentro
                  das novidades mais quentes. Ando sempre acompanhado de muito café e determinação.
                </TypographyDescriptionContent>
              </PaperDescription>
            </GridDescription>
          ...
          <GridAboutMeItems container item xs={12}>
            ...
            <GridDescriptionSite container item xs={12}>
              <PaperDescription>
                ...
                <TypographyDescriptionSite>
                  <ContainerDescriptionSite>
                    ...
                    <IconItem>
                      ...
                      <Data><i>Responsivo</i></Data>
                    </IconItem>

                    <IconItem>
                      <StyleIconDescription />
                      <Data><i>Material UI</i></Data>
                    </IconItem>

                    <IconItem>
                      <TodayIconDescription />
                      <Data><i>Junho de 2020</i></Data>
                    </IconItem>
                  </ContainerDescriptionSite>
                </TypographyDescriptionSite>
                ...
                <TypographyDescriptionContent>
                  O presente site foi desenvolvido em React juntamente ao Material UI e styled-components, e surgiu da necessidade
                  que encontrei de disponibilizar em algum outro local um pouco sobre o meu contato com o mundo da programação.
                  Fora isso, se apresentou como um ótimo exercício para firmar meus conhecimentos e habilidades, além é claro, de
                  agregar novos aprendizados. <br /> <br />

                  <i>Última atualização em 11/06/2020</i>
                </TypographyDescriptionContent>
              </PaperDescription>
            </GridDescriptionSite>
...
const PaperImageSite = styled(Paper)`
  && {
    ...
    padding: 15px;
    background: linear-gradient(0deg, rgba(70,70,70,1) 0%, rgba(0,0,0,1) 100%);
  }
`
